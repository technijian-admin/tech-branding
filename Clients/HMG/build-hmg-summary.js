...
const children = [
  ...
  pRuns([{ text: 'Augment, not replace. ', bold: true, color: DARK_CHARCOAL }, { text: 'Your Network Administrator keeps control and gains a named, security-first Technijian pod plus the 24/7 SOC, after-hours coverage, compliance evidence, and project bandwidth one person cannot sustain alone. On the AI side, we apply assistive automation to the operations you already run — with PHI kept in private, governed deployments.' }], { spaceAfter: 100 }),
