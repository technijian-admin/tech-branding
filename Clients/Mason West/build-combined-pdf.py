"""
Build a combined PDF: Cover Letter + Resume for Mason West LLC
...
def project_table():
    ...
    rows = [
        ["AI Readiness Assessment", "Discovery engagement to map current workflows across engineering, estimating, fabrication, project management, and field operations; identify top AI opportunities ranked by ROI and feasibility; deliver an executive-ready roadmap"],
        ["Intelligent Estimating", "AI analysis of project specs, seismic codes, and historical job data to accelerate takeoffs, improve bid accuracy, and reduce estimating cycle time"],
        ["Smart Fabrication Ops", "AI-assisted production scheduling, materials optimization, quality inspection analytics, and predictive maintenance for your 40,000 sq ft fabrication facility"],
        ["Engineering Knowledge AI", "AI-powered seismic code interpretation, product selection guidance, installation best practices, and automated spec review \u2014 capturing and scaling institutional engineering knowledge"],
        ["AI Document Intelligence", "Automated processing of project specs, RFPs, submittals, compliance documents, and ITAR-controlled materials \u2014 with role-based access controls and audit trails"],
        ["Executive AI Briefing", "Half-day leadership workshop: manufacturing and engineering AI landscape, live demos tailored to Mason West, competitive positioning, and prioritized opportunity assessment"],
    ]
...
story.append(Paragraph("<b>Mason West LLC</b>", S_BOLD))
story.append(Paragraph("Attn: Executive Leadership", S_BODY))
story.append(Paragraph("1601 E Miraloma Ave", S_BODY))
story.append(Paragraph("Placentia, CA 92870", S_BODY))
story.append(Spacer(1, 18))
story.append(Paragraph("<b>Dear Mason West Leadership Team,</b>", S_BOLD))
story.append(Spacer(1, 8))

story.append(Paragraph(
    'I\u2019m writing to introduce <font name="CalB" color="#006DB6">Technijian Corporation</font> '
    'and the AI consulting services we provide to established engineering and manufacturing firms. '
    'With <b>50+ years of industry experience, ISO 9001 &amp; AS9100 certification, ITAR registration, '
    'and 4 offices across California</b>, Mason West represents exactly the type of operationally complex, '
    'precision-driven business where targeted AI adoption can create outsized returns \u2014 without disrupting what already works.', S_BODY))

story.append(Paragraph(
    'I\u2019m Ravi Jain, Founder &amp; CEO of Technijian, an AI strategy and implementation consulting firm based in Irvine. '
    'I\u2019ve spent 25+ years helping organizations across manufacturing, financial services, healthcare, and professional services '
...
story.append(section_hdr("WHY MASON WEST"))
story.append(Spacer(1, 6))
story.append(Paragraph(
    'Your organization has qualities that make AI adoption both high-impact and low-risk: a diversified service offering '
    'spanning seismic restraint, vibration control, noise control, and MEPF solutions; engineering and fabrication capabilities '
    'serving military, aerospace, and commercial sectors; multi-office coordination across California; and rigorous '
    'ISO 9001, AS9100, and ITAR compliance requirements that demand precision in every process.', S_BODY))
story.append(Paragraph(
    'Based on my review of your operations and capabilities, I see several areas where AI can deliver '
    '<b>immediate, measurable ROI</b> for Mason West:', S_BODY))
...
story.append(Spacer(1, 6))
story.append(Paragraph(
    '<font name="CalB" color="#F67D4B">\u25b8 Local Partner:</font> '
    'We\u2019re based in Irvine, just minutes from your Placentia headquarters \u2014 we understand the SoCal '
    'construction and engineering landscape and can be on-site when it matters.', S_BODY))
story.append(Paragraph(
...
story.append(Paragraph(
    '<font name="CalB" color="#F67D4B">\u25b8 Compliance-First Design:</font> '
    'Every solution we design includes access controls, audit trails, and data governance \u2014 '
    'critical when handling ITAR-controlled materials, AS9100 quality documents, and sensitive project specs.', S_BODY))
story.append(Paragraph(
    ...
    'and enterprise-grade LLM workflows \u2014 with the same rigor we\u2019d bring to Mason West.', S_BODY))
...
story.append(Paragraph(
    ...
    'Mason West\u2019s operations, engineering efficiency, and competitive positioning. An '
...
#  BUILD PDF
# ═══════════════════════════════════════════
out_path = os.path.join(os.path.dirname(__file__), "Ravi_Jain_Technijian_Mason_West.pdf")
