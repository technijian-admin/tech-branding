"""Render every page of the STF PDFs to JPGs in _verify/ for visual proofreading.
Usage:  py -3.12 "Clients/STF/render-verify.py"
"""
...
JOBS = [
    (HERE / 'Shoes-That-Fit-AI-Growth-Blueprint.pdf', 'p'),
    (HERE / 'Shoes-That-Fit-Executive-Summary.pdf', 'sum'),
]
