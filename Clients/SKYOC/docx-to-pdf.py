"""
DOCX -> PDF for the SKYOC (Skyline Displays of Orange County) deliverables, via Word COM (pywin32).
Updates the Table of Contents fields before exporting (docx-js TOC ships empty until Word refreshes it).

Usage:  C:/Python314/python.exe Clients/SKYOC/docx-to-pdf.py [docx] [pdf]
        (defaults to the full report; pass a path to convert the summary)
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Skyline-OC-AI-Growth-Report.docx')
