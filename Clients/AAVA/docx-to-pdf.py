"""
DOCX -> PDF for the AAVA (The Aventine at Aliso Viejo) deliverable, via Word COM (pywin32).
...
Usage:  /c/Python314/python.exe Clients/AAVA/docx-to-pdf.py
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Aventine-AI-Growth-Report.docx')
