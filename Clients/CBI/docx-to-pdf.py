"""
DOCX -> PDF for the CBI deliverable, via Word COM (pywin32).
...
Usage:  python Clients/CBI/docx-to-pdf.py
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Christian-Brothers-AI-Growth-Report.docx')
