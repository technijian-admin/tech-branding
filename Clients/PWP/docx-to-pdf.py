"""
DOCX -> PDF for the PWP (Prosperity Wealth Planning) deliverable, via Word COM (pywin32).
Updates the Table of Contents fields before exporting (docx-js TOC ships empty
until Word refreshes it). Usage: python Clients/PWP/docx-to-pdf.py
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Prosperity-Wealth-Planning-AI-Blueprint.docx')
WD_FORMAT_PDF = 17
