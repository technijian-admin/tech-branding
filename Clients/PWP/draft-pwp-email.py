# Draft a removal-confirmation + goodwill reply to Prosperity Wealth Planning's unsubscribe, blueprint attached.
...
TARGET = "carolanne@prosperitywealthplanning.com"
...
PDF = pathlib.Path(r"c:\vscode\tech-branding\tech-branding\Clients\PWP\Prosperity-Wealth-Planning-AI-Blueprint.pdf")
...
# find the unsubscribe message from Prosperity
...
<p>Before I go, there's one thing I'd rather simply leave with you. After reading about Prosperity Wealth Planning, I put together a short, no-strings analysis of how AI could help a fee-only practice like yours - mainly by giving your advisors their time back from meeting notes and plan drafting, and helping more of the right clients find a true fiduciary - all while keeping client financial information private and compliant, with an advisor in the loop on anything a client sees. It's attached, yours to keep, with no expectation of anything in return.</p>
<p>If it's useful, wonderful. If not, no worries at all - and thank you for the work you do helping people retire with confidence.</p>
<p>Thank you,</p>
</div>
"""+sig
...
requests.post(f"https://graph.microsoft.com/v1.0/users/{USER}/messages/{draft_id}/attachments",
    ...
    json={"@odata.type":"#microsoft.graph.fileAttachment",
          "name":"Prosperity-Wealth-Planning-AI-Blueprint.pdf",
