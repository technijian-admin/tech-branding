"""
DOCX -> PDF for the MBCA (MBC Aquatic Sciences) deliverable, via Word COM (pywin32).
Updates the Table of Contents fields before exporting (docx-js TOC ships empty
until Word refreshes it; the win32com path does refresh it).

Usage:  C:/Python314/python.exe Clients/MBCA/docx-to-pdf.py [in.docx] [out.pdf]
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'MBC-AI-Growth-Report.docx')
