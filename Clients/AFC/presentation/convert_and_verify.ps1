# Convert AFC deck PPTX -> PDF + per-slide PNGs, and verify embedded speaker notes count.
$ErrorActionPreference = "Stop"
$dir = "C:\vscode\tech-branding\tech-branding\Clients\AFC\presentation"
$pptxPath = Join-Path $dir "Technijian for Abound Food Care - First Meeting Deck.pptx"
$pdfPath = Join-Path $dir "Technijian for Abound Food Care - First Meeting Deck.pdf"
...
$zipCopy = Join-Path $env:TEMP "afc_deck_check.zip"
Copy-Item $pptxPath $zipCopy -Force
$extractDir = Join-Path $env:TEMP "afc_deck_check"
