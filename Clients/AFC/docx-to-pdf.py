"""Convert Abound-AI-Growth-Report.docx to PDF via Word COM.
...
DOCX = Path(__file__).parent / 'Abound-AI-Growth-Report.docx'
PDF  = Path(__file__).parent / 'Abound-AI-Growth-Report.pdf'
