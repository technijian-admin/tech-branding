"""
DOCX -> PDF for the TALY deliverable, via Word COM (pywin32).
...
Usage:  /c/Python314/python.exe Clients/TALY/docx-to-pdf.py
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Talley-Associates-AI-Growth-Report.docx')
