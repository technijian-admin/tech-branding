"""
Build a combined PDF: Cover Letter + Resume for Anderson Real Estate
...
def project_table():
    ...
    rows = [
        ["AI Readiness Assessment", "Discovery engagement to map current workflows across leasing, property management, tenant communications, and finance; identify top AI opportunities ranked by ROI and feasibility; deliver an executive-ready roadmap"],
        ["Tenant Intelligence Platform", "AI-powered analytics across your tenant base: lease renewal prediction, rent collection risk scoring, tenant satisfaction signals, and automated communication workflows"],
        ["Portfolio Performance AI", "Automated performance dashboards across your properties and markets: occupancy trend analysis, revenue optimization modeling, market comparison intelligence, and anomaly detection"],
        ["Smart Property Ops", "AI-assisted maintenance ticketing and prioritization, vendor management optimization, predictive maintenance scheduling, and energy usage intelligence across your engineering teams"],
        ["AI Document Intelligence", "Automated lease abstraction, compliance document processing, vendor contract analysis, and AI-assisted RFP/questionnaire responses \u2014 dramatically reducing manual review time"],
        ["Executive AI Briefing", "Half-day leadership workshop: real estate AI landscape, live demos tailored to Anderson\u2019s portfolio, competitive positioning, and prioritized opportunity assessment"],
    ]
...
story.append(Paragraph("April 7, 2026", S_DATE))
story.append(Spacer(1, 18))
story.append(Paragraph("<b>Anderson Real Estate</b>", S_BOLD))
story.append(Paragraph("Attn: Executive Leadership", S_BODY))
story.append(Paragraph("1800 Avenue of the Stars, Suite 200", S_BODY))
story.append(Paragraph("Los Angeles, CA 90067", S_BODY))
story.append(Spacer(1, 18))
story.append(Paragraph("<b>Dear Anderson Real Estate Leadership Team,</b>", S_BOLD))
story.append(Spacer(1, 8))

story.append(Paragraph(
    'I\u2019m writing to introduce <font name="CalB" color="#006DB6">Technijian Corporation</font> '
    'and the AI consulting services we provide to established real estate development and property management firms. '
    'With a portfolio of <b>53+ properties spanning 3.1 million square feet across 9 markets</b> and 250+ tenants, '
    'Anderson Real Estate represents exactly the type of operationally complex, relationship-driven business where '
    'targeted AI adoption can create outsized returns \u2014 without disrupting what already works.', S_BODY))

story.append(Paragraph(
    'I\u2019m Ravi Jain, Founder &amp; CEO of Technijian, an AI strategy and implementation consulting firm based in Irvine. '
    'I\u2019ve spent 25+ years helping organizations across real estate, financial services, healthcare, and professional services '
...
story.append(section_hdr("WHY ANDERSON REAL ESTATE"))
story.append(Spacer(1, 6))
story.append(Paragraph(
    'Your organization has qualities that make AI adoption both high-impact and low-risk: a large, diversified portfolio '
    'across office, retail, mixed-use, and industrial assets; a 162-person team managing geographically dispersed properties '
    'from Beverly Hills to Hawaii; and a family-ownership culture that values long-term operational excellence over short-term disruption.', S_BODY))
story.append(Paragraph(
    'Based on my review of your portfolio and operations, I see several areas where AI can deliver '
    '<b>immediate, measurable ROI</b> for Anderson Real Estate:', S_BODY))
...
story.append(Spacer(1, 6))
story.append(Paragraph(
    '<font name="CalB" color="#F67D4B">\u25b8 Real Estate Experience:</font> '
    'We serve property management and real estate firms as a core vertical \u2014 we understand lease cycles, tenant relationships, '
    'CAM reconciliation, and the operational complexity of managing a diversified portfolio.', S_BODY))
story.append(Paragraph(
...
story.append(Paragraph(
    '<font name="CalB" color="#F67D4B">\u25b8 Security &amp; Compliance First:</font> '
    'Every solution we design includes access controls, audit trails, and data governance \u2014 '
    'critical when handling tenant PII, financial data, and lease documents.', S_BODY))
story.append(Paragraph(
    ...
    'and enterprise-grade LLM workflows \u2014 with the same rigor we\u2019d bring to Anderson.', S_BODY))

story.append(Spacer(1, 12))
story.append(Paragraph(
    'I\u2019d welcome the opportunity to schedule a 30-minute introductory call with your leadership team to discuss how AI can strengthen '
    'Anderson Real Estate\u2019s operations, tenant experience, and competitive positioning. An '
...
#  BUILD PDF
# ═══════════════════════════════════════════
out_path = os.path.join(os.path.dirname(__file__), "Ravi_Jain_Technijian_Anderson_Real_Estate.pdf")
