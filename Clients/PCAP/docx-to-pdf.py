"""
DOCX -> PDF for the PCAP (Pet Care Plus) deliverable, via Word COM (pywin32).
Updates the Table of Contents fields before exporting (docx-js TOC ships empty
until Word refreshes it). Usage: python Clients/PCAP/docx-to-pdf.py
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Pet-Care-Plus-AI-Growth-Report.docx')
WD_FORMAT_PDF = 17
