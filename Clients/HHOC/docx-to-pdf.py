"""
DOCX -> PDF for the HHOC deliverable, via Word COM (pywin32).
...
Usage:  python Clients/HHOC/docx-to-pdf.py
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Housing-for-Health-AI-Growth-Report.docx')
