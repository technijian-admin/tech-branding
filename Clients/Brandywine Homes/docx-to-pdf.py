"""
DOCX -> PDF for the Brandywine Homes (BWH) deliverable, via Word COM (pywin32).
...
Usage:  py -3.12 "Clients/Brandywine Homes/docx-to-pdf.py"
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Brandywine-Homes-AI-Growth-Report.docx')
