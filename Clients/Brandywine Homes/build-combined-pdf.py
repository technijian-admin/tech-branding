"""
Build a combined PDF: Cover Letter + Resume for Brandywine Homes
...
def project_table():
    ...
    rows = [
        ["AI Readiness Assessment", "Discovery engagement to map current workflows across land acquisition, entitlements, construction management, sales &amp; marketing, and finance; identify top AI opportunities ranked by ROI and feasibility; deliver an executive-ready roadmap"],
        ["Entitlement Intelligence", "AI analysis of municipal zoning codes, planning commission records, and public hearing outcomes to accelerate site evaluation and reduce entitlement risk"],
        ["Construction Ops AI", "AI-assisted project scheduling, subcontractor coordination, budget variance detection, change order analysis, and predictive timeline modeling across active communities"],
        ["Buyer Intelligence Platform", "AI-powered lead scoring, buyer journey analytics, automated follow-up workflows, and market demand prediction to optimize sales velocity"],
        ["AI Document Intelligence", "Automated processing of entitlement applications, construction contracts, title documents, HOA governance documents, and municipal correspondence \u2014 dramatically reducing manual review time"],
        ["Executive AI Briefing", "Half-day leadership workshop: homebuilder AI landscape, live demos tailored to Brandywine Homes, competitive positioning, and prioritized opportunity assessment"],
    ]
...
story.append(Paragraph("<b>Brandywine Homes</b>", S_BOLD))
story.append(Paragraph("Attn: Brett Whitehead, Principal / CEO", S_BODY))
story.append(Paragraph("2355 Main Street, Suite 210", S_BODY))
story.append(Paragraph("Irvine, CA 92614", S_BODY))
story.append(Spacer(1, 18))
story.append(Paragraph("<b>Dear Brett,</b>", S_BOLD))
story.append(Spacer(1, 8))

story.append(Paragraph(
    'I\u2019m writing to introduce <font name="CalB" color="#006DB6">Technijian Corporation</font> '
    'and the AI consulting services we provide to established residential homebuilders and developers. '
    'With <b>30+ years of infill development experience, 60+ communities built, and $1.2 billion in cumulative revenue</b>, '
    'Brandywine Homes represents exactly the type of operationally complex, execution-driven business where '
...
story.append(section_hdr("WHY BRANDYWINE HOMES"))
story.append(Spacer(1, 6))
story.append(Paragraph(
    'Your organization has qualities that make AI adoption both high-impact and low-risk: a proven track record navigating '
    'complex infill entitlement processes across Southern California; successful public-private partnerships with SoCal municipalities; '
    'a lean team managing multiple active communities simultaneously; and a family-ownership culture that values long-term '
    'operational excellence over short-term disruption.', S_BODY))
story.append(Paragraph(
    'Based on my review of your operations and market position, I see several areas where AI can deliver '
    '<b>immediate, measurable ROI</b> for Brandywine Homes:', S_BODY))
...
story.append(Paragraph(
    ...
    'We\u2019re based in Irvine and understand the SoCal infill development landscape \u2014 the entitlement complexities, '
    'municipal dynamics, and market conditions that shape your business.', S_BODY))
story.append(Paragraph(
...
story.append(Paragraph(
    '<font name="CalB" color="#F67D4B">\u25b8 Construction &amp; Real Estate Experience:</font> '
    'We serve property management firms, developers, and construction companies as core verticals \u2014 '
    'we understand the operational complexity of managing multiple communities, subcontractors, and municipal relationships.', S_BODY))
story.append(Paragraph(
    ...
    'and enterprise-grade LLM workflows \u2014 with the same rigor we\u2019d bring to Brandywine Homes.', S_BODY))

story.append(Spacer(1, 12))
story.append(Paragraph(
    'As a fellow Irvine-based company, I\u2019d welcome the opportunity to schedule a 30-minute introductory call to discuss how AI can strengthen '
    'Brandywine Homes\u2019 operations, sales velocity, and competitive positioning. An '
...
#  BUILD PDF
# ═══════════════════════════════════════════
out_path = os.path.join(os.path.dirname(__file__), "Ravi_Jain_Technijian_Brandywine_Homes.pdf")
