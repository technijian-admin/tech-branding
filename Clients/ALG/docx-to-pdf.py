"""
DOCX -> PDF for the ALG (Algro International) deliverable, via Word COM (pywin32).
...
Usage:  /c/Python314/python.exe Clients/ALG/docx-to-pdf.py
"""
import os
import sys
import time
...
DOCX = os.path.join(HERE, 'Algro-AI-Growth-Report.docx')
