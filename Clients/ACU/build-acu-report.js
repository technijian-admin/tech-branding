...
// ---------- 12 AI ENGINE ----------
docChildren.push(
  ...sectionHeader('How AI Transforms Acuity’s Growth Engine', CORE_BLUE, '12'),
  spacer(100),
...
docChildren.push(
  ...
  buildTable(
    ...
    [
      ...
      [{ text: 'ENTRY PROGRAM SUBTOTAL', bold: true }, { text: 'Builds on the IT + security already in place; the new cost is My SEO + Lead Gen Starter + the TBD item', bold: true }, { text: '', bold: true }, { text: 'In place + new', bold: true, color: CORE_BLUE }],
...
docChildren.push(
  ...
  buildTable(
    ...
    [
      ...
      ['3.2 — Knowledge System + ROI Dashboard', 'Stand up the institutional-knowledge system (matched precedents) and deliver the ROI dashboard against the Section 15 baselines.'],
    ],
  ),
);
...
docChildren.push(
  ...sectionHeader('Conclusion & Next Steps', DARK_CHARCOAL, '16'),
  spacer(100),
