"""My Sophos Report - HTML-to-PDF via Playwright + verification screenshots."""
import os
...
FILES = [
    {
        'html': 'My Sophos Report One-Pager.html',
        'pdf': 'My Sophos Report One-Pager.pdf',
    ...
    {
        'html': 'My Sophos Report Brochure.html',
        'pdf': 'My Sophos Report Brochure.pdf',
