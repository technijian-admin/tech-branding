...
MODULES = [
    ...
    },
    {
        "key": "Signal",
        "title_short": "Signal",
        "page_title": "Technijian My Compliance — Signal — SIEM + MDR for Compliance",
        "badge": "Compliance Module · SIEM + MDR",
        "tagline": "SIEM + MDR. Tuned for Compliance. Log ingestion, detection engineering, UEBA, and SOAR — calibrated to compliance frameworks, not just security.",
        "stats": [
            ("24/7", "MDR Monitoring"),
            ("UEBA", "Entity Risk"),
            ("MITRE", "ATT&CK Tagged"),
        ...
        "today": "Technijian delivers detection & response (MDR) via 3rd-party SIEM (Microsoft Sentinel · Splunk · others) with manual rule tuning and analyst triage. Effective but labor-intensive per tenant.",
        ...
        "why": [
            ...
            ("dark",       "24/7 MDR, Audit-Grade",       "Continuous monitoring with retained evidence: alert, response, resolution — all logged."),
        ...
        "engagement": [
            ...
            ("Managed Detection & Response", "Monthly 24/7 monitoring, triage, tuning, threat hunting, executive reporting"),
        ...
        "frameworks": ["HIPAA", "SOC 2", "PCI-DSS", "CMMC", "ISO 27001", "GDPR", "NIST 800-171", "HITRUST", "CCPA"],
        "cta_q": "Ready for compliance-grade logging and 24/7 MDR?",
    },
    {
        "key": "Shield",
        "title_short": "Shield",
