"""My M365 Report - HTML-to-PDF via Playwright + verification screenshots."""
import os
...
FILES = [
    {
        'html': 'My M365 Report One-Pager.html',
        'pdf': 'My M365 Report One-Pager.pdf',
    ...
    {
        'html': 'My M365 Report Brochure.html',
        'pdf': 'My M365 Report Brochure.pdf',
